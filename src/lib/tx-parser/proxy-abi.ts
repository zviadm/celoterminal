...
import BROKER_PROXY_V1_JSON from "../core-contracts/BrokerProxy-v1.json"
...
export const KnownProxies: KnownProxy[] = [
	...
	},
	{
		...
		abi: BROKER_PROXY_V1_JSON.abi as AbiItem[],
		bytecode: BROKER_PROXY_V1_JSON.deployedBytecode,
		implementation: {
			type:"method", method: "_getImplementation",
		},
	},
