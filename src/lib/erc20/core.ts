...
}[] = [coreErc20_CELO, coreErc20_cUSD, coreErc20_cEUR];
...
export type ConversionFunc = (
	...
	amount: BigNumber
) => Promise<{ coreErc20: CeloTokenType; amount: BigNumber }>;
...
export const Erc20InfiniteAmount = new BigNumber(
	"0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
);
export const Erc20InfiniteThreshold = new BigNumber(
